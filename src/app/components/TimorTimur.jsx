      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-5 w-11/12">
        ...
        <div className="p-5 bg-yellow-900 rounded-lg flex flex-col">
          ...
          <Dialog>
            ...
            <DialogContent className="bg-yellow-900 w-[1200px]">
              <DialogHeader>
                <DialogTitle className="text-white text-xl">1. Integrasi Timor Timur ke Indonesia dan Sejarah Awalnya</DialogTitle>
              </DialogHeader>
        ...
        <Image src="/timortimur/2.jpg" alt="Timor Timur" width={400} height={300} className="rounded-lg mb-10" />
          ...
          <Dialog>
            ...
            <DialogContent className="bg-yellow-900">
              <DialogHeader>
                <DialogTitle className="text-white text-xl">2. Dekolonisasi Portugal dan Dampaknya bagi Timor Timur</DialogTitle>
              </DialogHeader>
              <p className="text-white">
        ...
        <div className="p-4 bg-yellow-900 rounded-lg flex flex-col">
          ...
          <Dialog>
            ...
            <DialogContent className="bg-yellow-900">
              <DialogHeader>
                <DialogTitle className="text-white text-xl">3. Deklarasi Kemerdekaan Fretilin dan Operasi Seroja</DialogTitle>
              </DialogHeader>
        ...
        <div className="p-4 bg-yellow-900 rounded-lg flex flex-col">
          ...
          <Dialog>
            ...
            <DialogContent className="bg-yellow-900">
              <DialogHeader>
                <DialogTitle className="text-white text-xl">4. Konflik dan Perlawanan di Timor Timur Pasca-Integrasi</DialogTitle>
              </DialogHeader>
              <p className="text-white">
        ...
        <div className="p-4 bg-yellow-900 rounded-lg flex flex-col">
          ...
          <Dialog>
            ...
            <DialogContent className="bg-yellow-900">
              <DialogHeader>
                <DialogTitle className="text-white text-xl">5. Referendum 1999 dan Kemerdekaan Timor Leste</DialogTitle>
              </DialogHeader>
